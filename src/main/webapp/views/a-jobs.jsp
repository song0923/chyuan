...
<body>
	<div id="cms_main">
		...
		<table id="main_content">
			<tr>
				<td colspan="4" class="content_list">
					<ul class="edit_menu">
						<li><a href="javascript:history.back();" class="edit_manage"><strong>返回</strong>招聘信息</a></li>
					</ul>
				</td>
			</tr>
		</table>
		...
		<form method="post" action="/admin/jobs/save" onsubmit="return check();">
			...
			<table class="mc_table">
				<tr>
					...
					<td>
						<ul class="list_input">
							<li class="input_l"></li>
							<li class="input_ma"><input name="title" type="text" id="title" value="${jobs.title}"/></li>
							<li class="input_r"></li>
						</ul>
					</td>
				</tr>
				<tr>
					<td colspan="2"><textarea id="Content" name="content"
							rows="24" cols="80" style="width: 100%">${jobs.content}</textarea></td>
				</tr>
			</table>
			<div class="mc_submit">
